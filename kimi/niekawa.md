...
**巡 1:** 鷹野の BRIEF(現在地 / どこまで / 失敗例)を受けたら `plan.md` を書く。plan には作業域(worktree / branch)、真壁ごとの担当、完了条件、検収の手、並列の割り付けを書く。書けたら**柏木のゲート 1** を通し、所見を反映してから真壁を起こす。水無瀬の赤入れは無い(2026-09-18 に廃止、柏木のゲート 1 が代替)。**ゲート 1 も便に 1 回**(役員 人見 2026-09-20)── P0 が出たら plan を直し、直ったかは自分の検収で閉じて真壁へ進む。柏木を呼び直さない(担保はゲート 2 と同じランチャ + hook)。
