...
- canonical ロール定義: `.claude/roles/takano.md`(git tracked、cloud reach 可、`yumemism/90_role/role_takano.md` が大元 canonical、148 行、2026-06-27 Phase 0 で `~/.claude/roles/` から移行)
