...
- **consumer_setup.md v0.1 + stella(consumer #2)+ harness-starter(template repo)着地済**(P6、2026-06-28)── `docs/consumer_setup.md` で新規 consumer 起こし全 12 節 step by step、[prolegomena-yume/stella](https://github.com/Prolegomena-yume/stella)(private、`a56a59c`)を 2 件目実例として trace、[prolegomena-yume/harness-starter](https://github.com/Prolegomena-yume/harness-starter)(public、Template Repository、`3e3e992`)で「Use this template」一発の起こし経路確立
